...
- [Introduction: What is an R package?](#intro)
- [Packages that need to be installed](#install)
- [The most basic R package](#basic)
- [Making a new R project](#project)
- [Adding documentation (help files)](#documentation)
- [Additional resources](#whatelse)
- [Uploading to and install from GitHub](#github)

********************************************************************************

<a name="intro">Introduction: What is an R package?</a>
================================================================================
...
<a name="install">Packages that need to be installed</a>
================================================================================
...
<a name="basic">The most basic R package</a>
================================================================================
...
<a name="project">Making a new R project</a>
================================================================================
...
<br><center>
![](images/roxygenise_man_folder.png)
</center><br>
...
<a name="github">Uploading to and install from GitHub</a>
================================================================================
...
<br><center>
![](images/notebook_inside.png)
</center><br>

With the notebook folder now added, I need to initialise a new GitHub repository (see [version control notes](https://stirlingcodingclub.github.io/version_control/vc_notes.html) for help).


<!---


At the minimal point, we can load the package for ourselves with the following.
...
Should install and use `roxygen2` package.
...
When the stuff is added to the R functions, can roxygenise.

```{r, eval = FALSE}
roxygenise();
```

A line has been added to the `DESCRIPTION` file. New file and folder added.
